...
export { HELP_TEXT, VERSION } from "./cli-metadata.js";
...
const isContentType = (value: string): value is ContentType =>
  CONTENT_TYPE_VALUES.includes(value as ContentType);

const isWorkflowProfile = (value: string): value is WorkflowProfile =>
  WORKFLOW_PROFILE_VALUES.includes(value as WorkflowProfile);
