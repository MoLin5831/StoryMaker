...
由 \`corepack pnpm package:binaries\` 生成。这个脚本写入的是依赖 Node.js 的启动器，不是原生单文件二进制。
...
这些文件保留 \`storyctl\` 文件名，用于兼容已有自动化。它们不包含 Node.js，也不包含 CLI 源码。运行时要求系统 \`PATH\` 中存在 Node.js 24 或更新版本，并执行 \`packages/cli/dist/index.js\`。
`,
  "utf8"
);
